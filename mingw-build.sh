...
do
    ...
    if [ -x "`which $CC`" ]
    then
        echo -e "\tmake install/MINGW/$CPU..."
        mkdir -p "install/MINGW/$CPU"
        echo -e "\tbuild install/MINGW/$CPU/WinDivert.dll..."
