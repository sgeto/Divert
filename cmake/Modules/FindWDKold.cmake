...
set(wdkregpath10 "[HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows Kits\\Installed Roots;KitsRoot10]")
get_filename_component(wdkpath10 ${wdkregpath10} ABSOLUTE)
...
find_path(
  ...
  HINTS ${wdkregpath10} ${wdkpath81} ${wdkpath80} ${WDK_ROOT_ALTERNATE}
)
...
if(WDK_FIND_COMPONENTS)
  find_package_handle_standard_args(WDKold DEFAULT_MSG WDK_LIBRARIES WDK_INCLUDE_DIRS)
else()
  find_package_handle_standard_args(WDKold DEFAULT_MSG WDK_INCLUDE_DIRS)
endif()
